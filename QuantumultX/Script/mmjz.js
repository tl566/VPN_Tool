...
* @ScriptURL         https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js
* ==/UserScript==

【QuantumultX】 :
*************************
[rewrite_local]
https://meow-api.sxyj.net/api/Member/SignNew url script-request-header https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js
[task_local]
15 7,15 * * * https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js, tag=喵喵记账, img-url=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Icon/mmjz.png
*************************
【Loon】 :
*************************
[Script]
http-request https://meow-api.sxyj.net/api/Member/SignNew tag=喵喵记账Cookie, script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js
cron "15 7,15 * * *" script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js,tag=喵喵记账
*************************
【Surge】 :
*************************
[Script]
喵喵记账 = type=cron,cronexp="15 7,15 * * *",wake-system=1,timeout=120,script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js
喵喵记账Cookie = type=http-request,pattern=https://meow-api.sxyj.net/api/Member/SignNew,script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js
*************************
【小火箭】 :
*************************
[Script]
喵喵记账 = type=cron,script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js, cronexpr="15 7,15 * * *", timeout=500, enable=true
喵喵记账Cookie = type=http-request,pattern=https://meow-api.sxyj.net/api/Member/SignNew,script-path=https://codeberg.org/ddgksf2013/Cuttlefish/raw/branch/master/Script/mmjz.js
*************************
